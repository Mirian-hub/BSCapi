...
namespace WebApplicationGrid.Models
{
    ...
    public partial class StockCarGroupTable
    {
        ...
        public StockCarGroupTable()
        {
            ...
            this.StockCarGroupTable1 = new HashSet<StockCarGroupTable>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<StockCarGroupTable> StockCarGroupTable1 { get; set; }
        public virtual StockCarGroupTable StockCarGroupTable2 { get; set; }
    }
}
