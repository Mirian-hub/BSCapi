...
namespace WebApplicationGrid.Models
{
    ...
    public partial class StockDiscountTable
    {
        ...
        public System.DateTime StockDiscountValidFrom { get; set; }
        public System.DateTime StockDiscountValidTo { get; set; }
    
        public virtual StockDiscountStatusTable StockDiscountStatusTable { get; set; }
        public virtual StockDiscountTypeTable StockDiscountTypeTable { get; set; }
    }
}
