...
namespace WebApplicationGrid.Controllers
{
    public class BSCController : Controller
    {
        ...
        BSCOperations op = new BSCOperations();
        ...
        protected void SetOparationsValuesAndNames()
        {
            ...
            var _context = new BSCTestDBEntities3();
        ...
        public ActionResult GetOperations()
        {
            ...
            using (var _context = new BSCTestDBEntities3())
            {
                op.Opearations = _context.BSCTestTs.ToList();
